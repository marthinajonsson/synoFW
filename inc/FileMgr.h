...
public:
    ...
    std::map<std::string, bool> needUpdate ()
    {
        ...
        auto files = {"title.akas.tsv", "title.basics.tsv", "title.crew.tsv", "title.episode.tsv", "name.basics.tsv", "title.principals.tsv.gz"};
    ...
    void fetch ()
    {
        auto files = {"title.akas.tsv.gz", "title.basics.tsv.gz", "title.crew.tsv.gz", "title.episode.tsv.gz", "name.basics.tsv.gz", "title.principals.tsv.gz"};
